...
#define JOB_VET_SQUAD_LEADER "Veteran Squad Leader"
...
#define JOB_SQUAD_ROLES_LIST list(JOB_SQUAD_MARINE, JOB_VET_SQUAD_LEADER, JOB_SQUAD_LEADER, JOB_SQUAD_ENGI, JOB_SQUAD_MEDIC, JOB_SQUAD_SPECIALIST, JOB_SQUAD_SMARTGUN, JOB_SQUAD_TEAM_LEADER)
